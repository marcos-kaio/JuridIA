    ...
    <div className="w-full min-h-screen bg-[#1F2A44] flex justify-center items-center p-5 box-border">
      <div className="w-full max-w-5xl bg-[#F4F7FB] rounded-lg p-10 md:p-12 box-border flex flex-col gap-6">
        ...
        <div className="text-left">
          <h1 className="text-[#1F2A44] text-4xl md:text-5xl font-bold font-montserrat">Sign up</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-5">
            <div className="relative flex items-center bg-[rgba(229,229,230,0.81)] rounded-md w-full">
              ...
              <input type="email" placeholder="Digite seu E-mail" className="w-full p-5 pl-12 bg-transparent text-lg text-[#1F2A44] rounded-md focus:outline-none focus:ring-2 focus:ring-[#0DACAC] placeholder:text-[#AFAFAF]" />
            </div>
            <div className="relative flex items-center bg-[rgba(229,229,230,0.81)] rounded-md w-full">
              <div className="absolute left-4 pointer-events-none">
              ...
              <input type="text" placeholder="Digite seu nome" className="w-full p-5 pl-12 bg-transparent text-lg text-[#1F2A44] rounded-md focus:outline-none focus:ring-2 focus:ring-[#0DACAC] placeholder:text-[#AFAFAF]" />
            </div>
            <div className="relative flex items-center bg-[rgba(229,229,230,0.81)] rounded-md w-full">
              <div className="absolute left-4 pointer-events-none">
              ...
              <input type="text" placeholder="Data de nascimento" className="w-full p-5 pl-12 bg-transparent text-lg text-[#1F2A44] rounded-md focus:outline-none focus:ring-2 focus:ring-[#0DACAC] placeholder:text-[#AFAFAF]" onFocus={(e) => (e.target.type = "date")} onBlur={(e) => (e.target.type = "text")} />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-5">
            <div className="relative flex items-center bg-[rgba(229,229,230,0.81)] rounded-md w-full">
              ...
              <select className="w-full p-5 pl-12 bg-transparent text-lg text-[#AFAFAF] rounded-md focus:outline-none focus:ring-2 focus:ring-[#0DACAC] appearance-none cursor-pointer invalid:text-[#AFAFAF] focus:text-[#1F2A44]" defaultValue="">
            ...
            <div className="relative flex items-center bg-[rgba(229,229,230,0.81)] rounded-md w-full">
              ...
              <input type="password" placeholder="Digite sua senha" className="w-full p-5 pl-12 bg-transparent text-lg text-[#1F2A44] rounded-md focus:outline-none focus:ring-2 focus:ring-[#0DACAC] placeholder:text-[#AFAFAF]" />
            </div>
            <div className="relative flex items-center bg-[rgba(229,229,230,0.81)] rounded-md w-full">
              <div className="absolute left-4 pointer-events-none">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="11" width="18" height="11" rx="2" ry="2" stroke="#AFAFAF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M7 11V7C7 4.23858 9.23858 2 12 2C14.7614 2 17 4.23858 17 7V11" stroke="#AFAFAF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
        ...
        <div className="flex flex-col items-center gap-4 mt-2.5">
            <button className="w-full max-w-[280px] py-4 px-8 bg-[#0DACAC] text-white text-2xl font-medium rounded-2xl cursor-pointer hover:bg-[#089a9a] transition-colors">Registrar</button>
