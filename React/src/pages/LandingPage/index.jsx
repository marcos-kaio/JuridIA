...
function LandingPage() {
  ...
  // --- INÍCIO DA MUDANÇA ---
  // Lógica de "Scroll Spy" usando Intersection Observer (mais precisa)
  useEffect(() => {
    const observerCallback = (entries) => {
      entries.forEach(entry => {
        // Se a seção estiver visível na área de detecção, atualiza o estado
    ...
    const observer = new IntersectionObserver(observerCallback, {
      // O rootMargin negativo "encolhe" a área de detecção pelo tamanho do seu header.
      // A seção só é considerada "ativa" quando seu topo aparece abaixo do header.
      rootMargin: "-96px 0px -50% 0px", // 96px é a altura do header (h-24)
      threshold: 0,
    });
  ...
  return (
    <>
      <div className="w-full max-w-[1512px] mx-auto text-[#1F2A44] font-poppins bg-[#F4F7FB]">
        <header className="sticky top-0 z-50 bg-[#F4F7FB] shadow-md relative flex items-center justify-between h-24 px-20">
        ...
        <main>
          <section id="home" ref={el => sectionRefs.current.home = el} className="scroll-section flex justify-center text-center py-20 px-10">
          ...
          <section id="how-it-works" ref={el => sectionRefs.current['how-it-works'] = el} className="scroll-section flex flex-col items-center text-center py-20 px-10">
          ...
          <section id="about" ref={el => sectionRefs.current['about'] = el} className="scroll-section bg-white flex flex-col items-center text-center py-20 px-10">
          ...
          <section id="faq" ref={el => sectionRefs.current['faq'] = el} className="scroll-section flex flex-col items-center text-center py-20 px-10">
