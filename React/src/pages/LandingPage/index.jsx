    ...
    <div className='w-full text-[#1F2A44] font-poppins bg-[#F4F7FB]'>
      <header className='fixed top-0 left-0 right-0 z-50 h-32 bg-[#F4F7FB] shadow-md'>
        <div className='w-full max-w-[1512px] mx-auto h-full flex items-center justify-between px-20'>
          ...
          {logged ? (
            <Link to='/profile' className='w-16 h-16 cursor-pointer'>
              <svg
                width='64'
                height='64'
                viewBox='0 0 32 32'
            ...
            <div className='flex items-center gap-4'>
              <Link
                to='/login'
                className='font-bold text-xl rounded-md cursor-pointer no-underline bg-[#0DACAC] text-white py-3 px-8'
              >
                Entrar
              </Link>
              <Link
                to='/register'
                className='font-bold text-xl rounded-md cursor-pointer no-underline bg-[#F4F7FB] text-[#1F2A44] border border-[#1F2A44] py-3 px-6'
              >
                Cadastre-se
              </Link>
            </div>
      ...
      <main className='pt-32'>
        ...
        <ContractSimplifierSection
          sectionRef={sectionRefs['contract-simplifier']}
          logged={logged}
        />
      ...
      <footer className='bg-[#1F2A44] text-white text-center py-10 px-5'>
        <div className='max-w-[1512px] mx-auto'>
          <p className='m-0 font-light text-3xl'>
            © JuridIA. Todos os direitos reservados.
          </p>
          <p className='m-0 font-extralight text-2xl mt-2'>
